...
func handle_action_button_pressed():
	...
	var attack_range = hex_board.get_adjacent(current_tile.q, current_tile.r, current_tile.s, false)
	hex_board.change_list_of_tile_colors(attack_range, parent_object.TEST_MATERIAL_5)
	parent_object.attack_damage = 3
